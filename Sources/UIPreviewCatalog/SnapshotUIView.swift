...
func setupFileName(item: PreviewItem, preview: _Preview, previewIndex: Int) -> String {
...
func recordSnapshot(of view: UIView, with name: String) {
    let snapShot: UIImage = view.asImage()
    saveImage(of: snapShot, with: name)
}

func saveImage(of image: UIImage, with name: String) {
...
func getSaveDirectoryPath() -> String {
